...
report_tools() {
  ...
  tools[feroxbuster]='Feroxbuster Scan sub-directories|feroxbuster|feroxbuster -q -x php,asp,aspx,jsp,html,zip,jar --auto-tune -n --random-agent -w "$dicc" -o "$logfile" -u "$domain"'
